...
var mun = ee.FeatureCollection('users/dh-conciani/help/embrapa/municipalities_cerrado_biome');
var territory = ee.Image().paint(mun, 'id').rename('territory');
...
Export.table.toDrive({
    collection: areas,
    description: 'secVeg_municipalities',
    folder: driverFolder,
    fileFormat: 'CSV'
});
